...
|-----|-----|-----|-----|
| Apple has pricing power | Even during tariff pressure, inflation, and weak foreign currencies, company recorded an annual revenue increase of 8% | Management's Discussion and analysis, FY2025 10K | Shows that Apple can charge premium prices and still generate revenue and retain customers |
| Apple has a strong ecosystem | Apple has covered all types of personal use electronic products like phones, laptops, watches, and tvs with an integrated cloud service, digital content, and payment service system which links all devices owned by one person, sharing data | FY2025 Form 10K | A shared ecosystem is the company's biggest moat as it increases switching costs, maintaining customer loyalty and revenue generation |
...
|----|----|----|----|
| Brand | Premium pricing, cutomer loyalty, global recognistion | Customers trust the brand, allowing the company to launch new products successfully | Sustainable profit margins, long term demand |
...
The management also belives that the gross margins would be volatile in the future years mostly because the company's net sales have a majority of internationatil sales which face the tariff pressure. The company also has a complex line of supply, and it currently depends on limited sources for certain components, which exposes it to a lot of international economic and political risk. 
